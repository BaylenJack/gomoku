...
const oldSrc = fs.readFileSync('C:/Users/王巢三/AppData/Local/Temp/hint-old.js', 'utf8');
...
const oldEngine = loadEngine(patchedOld).computeBest;
const newEngine = loadEngine(newSrc).computeBest;
